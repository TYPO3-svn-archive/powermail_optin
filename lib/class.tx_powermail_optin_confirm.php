...
class tx_powermail_optin_confirm extends tslib_pibase {
	...
	function redirect() {
		...
		$typolink_conf = array (
		  ...
		  'additionalParams' => '&' . $this->prefixId . '[mailID]=' . ($this->obj->cObj->data['_LOCALIZED_UID'] > 0 ? $this->obj->cObj->data['_LOCALIZED_UID'] : $this->obj->cObj->data['uid']) . '&' . $this->prefixId . '[sendNow]=1&' . $this->prefixId . '[optinuid]=' . $this->piVars['optinuid'] . '&' . $this->prefixId . '[optinhash]=' . $this->piVars['optinhash']
		);
